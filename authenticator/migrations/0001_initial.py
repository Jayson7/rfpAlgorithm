    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_client_password_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_profile_owner', to='authenticator.password_log_on_user')),
        ...
        migrations.AddField(
            ...
            name='password',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_patient_used', to='authenticator.passwordstorage'),
        ),
    ]
