    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Device_used_username', to='authenticator.password_log_on_user')),
                ('user_profile_token', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Device_used_username', to='authenticator.userlogintoken')),
                ('username_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Device_used_username', to='authenticator.registerclient')),
            ],
        ),
        migrations.AddField(
